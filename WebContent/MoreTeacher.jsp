...
<script type="text/javascript">
	$(function(){
		...
		//})
		$("body").on("click","#likesearch",function(){
				...
				success: function(data){
					...
					for(var i=0; i<data.length; i++){
				        ...
				        "<div class='col-lg-9 col-md-9' >"+
				           ...
				           "<img src='images/"+data[i].timgsrc+"' class='img-responsive flyimg'/>"+
				           "<div class='over-image'></div></div>"+
				            ...
				            "<li style='padding:10px 0;'><input name='"+data[i].tid+"' type='button' class='radial_but orange addcar' value='加入购物车'></span></button>  </ul> </div>  <div class='col-lg-12' style='height:30px;margin:10px;'><hr size='3'></div>");				
						}
				},
...
<div class="courses_banner"><!--bacgroung-size设为cover  把背景图像扩展至足够大，以使背景图像完全覆盖背景区域。-->
		 ...
		 <div class="col-sm-12 dropdown-buttons">   
    	   ...
    	   <div class="col-sm-2 dropdown-button">           			
		     ...
		     <div class="col-sm-2 dropdown-button">
			  ...
			  <div class="col-sm-2  button_search">
    ...
    <span class="block_teacher">全部教员</span>
    <span class="block_teacher">  <a href="OrderTeacherDesc">按价格从高到低</a></span>
     <span class="block_teacher">  <a href="OrderTeacherAsc">按价格从低到高</a></span>
    </div>
    ...
    <div class="features" >
	   <div class="container" id="contain">
        ...
        <ul class="allteacher_btn">
          ...
          <li><a href="#" class="radial_but orange addcar"><i class="fa fa-shopping-cart"></i><span>&nbsp;&nbsp;加入购物车</span></a>
         </ul>
        </div>
       </div>
       ...
       <!-- --><c:forEach var="t" items="${requestScope.allteacher}">
        <input type="hidden" name="flag" value="${t.tid}" id="tid">
         <div class="col-lg-9 col-md-9">
           <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 event-img pre_teacher">
                <img src="images/${t.timgsrc}" class="img-responsive flyimg" alt=""/>
               <div class="over-image"></div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="">
            ...
            <div>${t.course}价格:${t.price}</div>
           </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <ul style="list-style:none;margin:30px 0;">
          <li> <a href="TeacherContent?tid=${t.tid}" class="radial_but "><i class="fa fa-file-o"></i><span>&nbsp;&nbsp;查看详情&nbsp;&nbsp;</span></a>
         
          <li style="padding:10px 0;"><input name="${t.tid}" type="button" class="radial_but orange addcar" id="addToCart" value="&nbsp;加入购物车&nbsp;"></button>
         </ul>
        </div>
