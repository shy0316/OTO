	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav ">
		        ...
		        <li class="dropdown">
		         ...
		         <li class="dropdown">
		            <a href="register.html"><i class="fa fa-plus-circle"></i><span>注册</span></a>
		        </li>
		        ...
		        <li> <div id="loginid" style="color:#fff;float:right;margin:20px 0 0 20px">你好，<span style="color:red">${sessionScope.user.username }</span></div></li>
		    </ul>
	    </div>
